...
namespace DotnetBleServer.Gatt.BlueZModel
{
    internal class GattPropertiesFactory
    {
        ...
        {
            var characteristicProperties = new GattCharacteristic1Properties {UUID = characteristic.UUID, Flags = CharacteristicFlagConverter.ConvertFlags(characteristic.Flags2)};
